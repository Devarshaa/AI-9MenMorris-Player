...
class MiniMaxGame:
    ...
    def staticEstimateMidEnd(self, board):
        ...
        if numWhitePieces <= 2:
            ...
            diffInExistingMills = self.numOfMills(board, 'W') - 3 * self.numOfMills(board, 'B')
            diffInPossibleMills = self.numOfPossibleMills(board, 'W') - 3 * self.numOfPossibleMills(board, 'B')
            return (100 * diffInPieces + 300 * diffInExistingMills + 3 * diffInPossibleMills - numBlackMoves)
